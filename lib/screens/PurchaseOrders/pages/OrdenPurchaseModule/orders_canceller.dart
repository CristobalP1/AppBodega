...
class OrderCancellerScreen extends StatefulWidget {
  const OrderCancellerScreen({Key? key}) : super(key: key);

  @override
  State<OrderCancellerScreen> createState() => _OrderCancellerScreenState();
}

class _OrderCancellerScreenState extends State<OrderCancellerScreen> {
  late Future<List<Producto1>> _ordenDetails;

  Future<List<Producto1>> _getOrdenDetails() async {
    final url = Uri.http(
      Environment.baseURL,
      'ordencompra/order_purchase_canceller/',
    );
