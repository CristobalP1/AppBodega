...
class ApppRoutes {
  ...
  static Map<String, Widget Function(BuildContext)> routes = {
    ...
    constants.createCategory: (BuildContext context) => const CreateCategoryScreen(),
    constants.createProduct: (BuildContext context) => const CreateProductScreen(),
    constants.editCategory: (BuildContext context) => const EditCategoryScreen(),
    ...
    //Providers Screen
    constants.activeProvider: (BuildContext context) => const ActiveProvidersScreen(),
    constants.inactiveProviders: (BuildContext context) => const InactiveProvidersScreen(),
    constants.createProvider: (BuildContext context) => const CreateProviderScreen(),
  };
